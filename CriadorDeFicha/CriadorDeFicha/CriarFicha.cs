...
namespace testes
{
    public class CriarFicha
    {
        ...
        {
            Console.Clear();
            var caminhoImagem = @"C:\Users\willi\OneDrive\Área de Trabalho\fichateste\CriadorDeFicha\CriadorDeFicha\img\fichaf.jpg";
            var caminhoFicha = @"C:\Users\willi\OneDrive\Área de Trabalho\ficha\fichapronta.pdf";
